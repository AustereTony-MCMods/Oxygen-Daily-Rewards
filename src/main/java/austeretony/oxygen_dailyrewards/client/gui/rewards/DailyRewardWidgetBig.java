    ...
    public void draw(int mouseX, int mouseY) {
        if (this.isVisible()) {   
            ...
            if (this.special) {
                ...
                GUIAdvancedElement.drawCustomSizedTexturedRect(this.getWidth() - 14, 2, 0, 0, 12, 12, 12, 12);     
                GlStateManager.disableBlend(); 
            }
            ...
            if (this.locked && !this.unreachable && !this.rewarded) {
                ...
                GUIAdvancedElement.drawCustomSizedTexturedRect(this.getWidth() - 14, this.getHeight() - 24, 0, 0, 12, 12, 12, 12);     
                GlStateManager.disableBlend(); 
            }
