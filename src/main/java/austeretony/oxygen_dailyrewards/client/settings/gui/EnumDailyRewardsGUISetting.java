package austeretony.oxygen_dailyrewards.client.settings.gui;
...
public enum EnumDailyRewardsGUISetting {

    //Alignment

    DAILY_REWARDS_MENU_ALIGNMENT("alignment_daily_rewards_menu", EnumValueType.INT, String.valueOf(0));
    ...
    EnumDailyRewardsGUISetting(String key, EnumValueType type, String baseValue) {
        this.key = key;
        this.type = type;
    ...
    public static void register() {
        for (EnumDailyRewardsGUISetting setting : values())
